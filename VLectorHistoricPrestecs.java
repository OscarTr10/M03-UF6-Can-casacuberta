...
public class VLectorHistoricPrestecs extends JFrame {
    ...
    private Usuari usuari;      //Esta línea si al final lo hago por el nombre va fuera.
    ...
    private void mostrarPrestecs() {
        int idUsuari = Usuari.getId();      //Aqui tengo que hacer algo así para que me pille la id.
